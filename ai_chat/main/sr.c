...
static mn_cmd_info_t s_mn_cmds[] = {
    {MN_CMDID_OPENTV,       "da kai dian shi",          "好的,正在打开电视"},
    {MN_CMDID_CLOSETV,      "guan bi dian shi",         NULL},
    {MN_CMDID_ADDVOLUME,    "sheng yin da dian",        "好的,正在增大声音"},
    {MN_CMDID_SUBVOLUME,    "sheng yin xiao dian",      "好的,正在减小声音"},
};
...
void feed_cb(void *pvParameters) {
    ...
    ESP_LOGI(TAG, "chunksize:%d i2s_buf_size:%u", chunksize, i2s_buf_size);
