...
#define CONFIG_UDP_MULTICAST_IP                 "225.10.100.200"
#define CONFIG_UDP_MULTICAST_PORT               60001
...
static void udp_server_cb(void *pvParameters) {
    ...
    local_addr.sin_port = htons(CONFIG_UDP_MULTICAST_PORT);
    ...
    mreq.imr_multiaddr.s_addr = inet_addr(CONFIG_UDP_MULTICAST_IP);
    ...
    ESP_LOGI(TAG, "udp multicast listen, %s:%u", CONFIG_UDP_MULTICAST_IP, CONFIG_UDP_MULTICAST_PORT);
